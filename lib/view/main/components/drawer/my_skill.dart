  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(percentage: 0.85, title: 'Sqlite',image: 'assets/icons/sqlite.jpg'),
        ...
        AnimatedLinearProgressIndicator(percentage: 0.93, title: 'Getx',image: 'assets/icons/getx.png'),
        AnimatedLinearProgressIndicator(percentage: 0.6, title: 'Riverpod', image: 'assets/icons/riverpod.png',)
      ],);
  }
}
